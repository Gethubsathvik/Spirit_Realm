...
// Minimal, in-repo protobuf-like types for local builds. These are a stop-gap until
// you generate the real .pb.go files with protoc. They live under
// app/services/packet_service/pb so the packet_service module doesn't need to
// resolve a nested proto module during CI.
